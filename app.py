...
def get_recommendations(username):
    ...
    # Calculate similarity matrix using Apriori algorithm
    transactions = [[str(pizza_id) for pizza_id in all_pizzas[i][0] if pizza_clusters[i] == cluster_label] for i in range(len(all_pizzas))]
